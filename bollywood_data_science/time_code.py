...
import os
import threading
from threading import RLock, local as ThreadLocalData
...
- Reported live to logger (to let the user know what the code is doing right now)
...
- Sub-function granularity
    ...
    Foo.foo: 0.3s
        ...
        def make_timed_func(func: FunctionType) -> FunctionType:
            return self.make_timed_func(
                func, print_start, print_time, print_args, run_gc
            )
